classdef HelperInitDefaultAgentData
    ...
    % types.
    %
    % NOTE: The name of this class and its functionality may change 
    ...
    methods(Static)
        ...
        % /////////////////////////////////////////////////////////////////
        function out = actorAction
            %ACTORACTION Returns the default actor action struct
            out = struct(...
                "ActorID", 0,...
                "PhaseInterval", EnumPhaseInterval(0),...
                "ActionType", EnumActionType(0));
        end
        ...
        % /////////////////////////////////////////////////////////////////
        function out = lateralOffsetAction
            %LATERALOFFSETACTION Returns the default lateral offset action struct
            out = struct(...
                "ActorAction", HelperInitDefaultAgentData.actorAction,...
                "OffsetValue", 0,...
